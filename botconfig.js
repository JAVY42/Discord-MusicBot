module.exports = {
  ...
  ClientID: process.env.Discord_ClientID || "923976441652211773", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "uRnCZXuaePYGjIsD6BZ-0WE_qTLSSzJ5", //Discord Client Secret
